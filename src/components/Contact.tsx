  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'mikayerdaulet@gmail.com',
      link: 'mailto:mikayerdaulet@gmail.com',
    },
    {
      icon: Phone,
      title: 'Phone',
    ...
    },
    {
      ...
      title: 'WhatsApp',
      value: 'Message Me',
      link: 'https://wa.me/14807847840?text=Hi%20Mika!%20I\'m%20interested%20in%20your%20photography%20services.%20Could%20you%20tell%20me%20more%20about%20your%20packages?',
    },
    {
      icon: MapPin,
      title: 'Location',
                ...
                >
                  ...
                  {info.title === 'WhatsApp' ? (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="inline-block px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                    >
                      {info.value}
                    </motion.a>
                  ) : (
                    <a
                      href={info.link}
                      className="inline-block text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium underline decoration-2 underline-offset-4 hover:decoration-blue-800 dark:hover:decoration-blue-300 transition-all duration-300 hover:scale-105"
                    >
                      {info.value}
                    </a>
                  )}
